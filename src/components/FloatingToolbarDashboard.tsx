        ...
        {dashboardItems.map((item) => {
          ...
          return (
            ...
            >
              {/* Icon Container */}
              <div
                className={`w-9 h-9 rounded-[10px] flex items-center justify-center transition-all duration-200 group-hover:scale-105 ${
                  item.isActive
              ...
              {/* Label */}
              <span
                className={`text-[10px] tracking-tight text-center truncate w-full transition-colors ${
                  item.isActive
